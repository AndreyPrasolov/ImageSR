...
from tensorflow.keras.applications.efficientnet_B7 import preprocess_input
...
class SrganTrainer:
    ...
    def __init__(self,
                 generator,
                 discriminator,
                 content_loss='EfficientNet54',
                 learning_rate=PiecewiseConstantDecay(boundaries=[100000], values=[1e-4, 1e-5])):

        if content_loss == 'EfficientNet22':
            self.efficientNet = srgan.efficientNet_22()
        elif content_loss == 'EfficientNet54':
            self.efficientNet = srgan.efficientNet_54()
        else:
            raise ValueError("content_loss must be either 'EfficientNet22' or 'EfficientNet54'")
    ...
    def _content_loss(self, hr, sr):
        ...
        sr_features = self.efficientNet(sr) / 12.75
        hr_features = self.efficientNet(hr) / 12.75
