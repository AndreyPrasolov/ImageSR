...
def efficientNet_22():
    return _efficientNet(5)


def efficientNet_54():
    return _efficientNet(20)


def _efficientNet(output_layer):
    efficientNet = EfficientNetB7(input_shape=(None, None, 3), include_top=False)
    return Model(efficientNet.input, efficientNet.layers[output_layer].output)
