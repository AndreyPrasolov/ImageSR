...
class SrganTrainer:
    ...
    def __init__(self,
                 generator,
                 discriminator,
                 content_loss='MobileNet54',
                 learning_rate=PiecewiseConstantDecay(boundaries=[100000], values=[1e-4, 1e-5])):

        if content_loss == 'MobileNet22':
            self.mobileNet = srgan.mobileNet_22()
        elif content_loss == 'MobileNet54':
            self.mobileNet = srgan.mobileNet_54()
        else:
            raise ValueError("content_loss must be either 'MobileNet22' or 'MobileNet54'")
    ...
    def _content_loss(self, hr, sr):
        ...
        sr_features = self.mobileNet(sr) / 12.75
        hr_features = self.mobileNet(hr) / 12.75
